...
class _InfoSectionItemState extends State<InfoSectionItem>
  ...
  late Animation<double> itemSizeAnimation;
  late Animation<double> itemBlurAnimation;
  ...
  void initState() {
    ...
    itemSizeAnimation = Tween<double>(begin: 0.1, end: 1).animate(
        CurvedAnimation(
            parent: itemController,
            curve: const Interval(0.6, 1, curve: Curves.elasticOut)));
    itemBlurAnimation = Tween<double>(begin: 0, end: 3).animate(
        CurvedAnimation(parent: itemController, curve: const Interval(0, 1)));
